...
namespace OconnorEvents.EventCatalog.Migrations
{
    ...
    [Migration("20210408155311_InitialCreate")]
            ...
            modelBuilder.Entity("OconnorEvents.EventCatalog.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 10, 8, 16, 53, 10, 586, DateTimeKind.Local).AddTicks(3886),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2022, 1, 8, 16, 53, 10, 589, DateTimeKind.Local).AddTicks(3332),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 8, 8, 16, 53, 10, 589, DateTimeKind.Local).AddTicks(3410),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 8, 8, 16, 53, 10, 589, DateTimeKind.Local).AddTicks(3440),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2022, 2, 8, 16, 53, 10, 589, DateTimeKind.Local).AddTicks(3465),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2021, 12, 8, 16, 53, 10, 589, DateTimeKind.Local).AddTicks(3496),
