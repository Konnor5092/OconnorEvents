...
namespace OconnorEvents.EventCatalog.Migrations
{
    ...
    [Migration("20210410215951_IEntityUpdate")]
            ...
            modelBuilder.Entity("OconnorEvents.EventCatalog.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2021, 10, 10, 22, 59, 50, 952, DateTimeKind.Local).AddTicks(7739),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2022, 1, 10, 22, 59, 50, 954, DateTimeKind.Local).AddTicks(9860),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 8, 10, 22, 59, 50, 954, DateTimeKind.Local).AddTicks(9913),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 8, 10, 22, 59, 50, 954, DateTimeKind.Local).AddTicks(9933),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2022, 2, 10, 22, 59, 50, 954, DateTimeKind.Local).AddTicks(9951),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2021, 12, 10, 22, 59, 50, 954, DateTimeKind.Local).AddTicks(9974),
